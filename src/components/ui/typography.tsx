...
function createComponent<T extends HTMLElement>(tag: keyof JSX.IntrinsicElements, defaultClassName: string, displayName: string) {
  const Component = ({ ref, ...props }: React.HTMLAttributes<T> & { ref?: React.RefObject<T | null> }) => {
